...
type DieSideIconProps = {
    color: Die,
    side: number
}

/**
 * Shows the icons for a particular die side
 */
export default function DieSideIcon({ color, side }: DieSideIconProps) {
