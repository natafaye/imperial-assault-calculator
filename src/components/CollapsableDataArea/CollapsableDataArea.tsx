...
type CollapsableDataAreaProps = {
    label: React.ReactNode,
    children: React.ReactNode,
    collapsedData: React.ReactNode,
    startCollapsed?: boolean
}

export default function CollapsableDataArea({ label, children, collapsedData, startCollapsed = false }: CollapsableDataAreaProps) {
    ...
    return (
        <div>
            <div className="d-flex align-items-center text-muted mt-4" role="button" tabIndex={0} onClick={() => setIsCollapsed(!isCollapsed)}>
