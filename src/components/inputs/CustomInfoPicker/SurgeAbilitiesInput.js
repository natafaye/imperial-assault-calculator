      ...
      {values.map((ability, index) => (
        (index === editIndex) ? (
          ...
          <div key={index}>
            ...
            <Button variant="outline-info" size="sm" className="ms-3 me-2" onClick={() => startEditAbility(index)}>
              <FontAwesomeIcon icon={faPencil} />
            </Button>
            <Button variant="outline-warning" size="sm" onClick={() => deleteAbility(index)}>
